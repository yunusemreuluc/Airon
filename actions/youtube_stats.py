...
@register_tool("get_youtube_channel_report")
def get_youtube_channel_report(query: str = "overview", handle: str = "", video_limit: int = DEFAULT_VIDEO_LIMIT) -> dict:
    ...
    try:
        ...
        return ok(" ".join(parts), channel=channel_title, subscribers=subscribers)
    except Exception as exc:
        return fail(f"YouTube istatistikleri alinamadi: {exc}")
